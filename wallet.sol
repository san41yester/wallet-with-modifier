...
contract Wallet {
    ...
    function sendvalwithoutfee(address dest, uint128 value) public pure checkOwnerAndAccept {
         
        dest.transfer(value, true, 0);
    }
    function sendvalwithfee(address dest, uint128 value) public pure checkOwnerAndAccept {
        
        dest.transfer(value, true, 1);
    }

    function sendallvalanddestroywallet(address dest, uint128 value) public pure checkOwnerAndAccept {
